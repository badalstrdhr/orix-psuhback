...
class orixapi{
	...
	public function booking($getpatameter) {
		...
		curl_setopt_array($curl, array(
		  CURLOPT_URL => 'https://reservecaruat.orixindia.com:8081/movein/seller/'.$selercode.'/booking/create',
	...
	public function modifybooknig($getpatameter) {
		...
		$curl = curl_init();
		curl_setopt_array($curl, array(
		  CURLOPT_URL => 'https://reservecaruat.orixindia.com:8081/movein/'.$selercode.'/se274/booking/modify',
		  CURLOPT_RETURNTRANSFER => true,
		  CURLOPT_ENCODING => '',
		  CURLOPT_MAXREDIRS => 10,
		  CURLOPT_TIMEOUT => 0,
	...
	function cancelbooknig($getpatameter){
		...
		$curl = curl_init();
		curl_setopt_array($curl, array(
		  CURLOPT_URL => 'https://reservecaruat.orixindia.com:8081/movein/seller/'.$selercode.'/booking/cancel',
		  CURLOPT_RETURNTRANSFER => true,
		  CURLOPT_ENCODING => '',
		  CURLOPT_MAXREDIRS => 10,
		  CURLOPT_TIMEOUT => 0,
	...
	function misbookingdetails($getpatameter){
		...
		$curl = curl_init();
		curl_setopt_array($curl, array(
		  CURLOPT_URL => 'https://reservecaruat.orixindia.com:8081/movein/seller/'.$selercode.'/booking/booking/mis',
		  CURLOPT_RETURNTRANSFER => true,
		  CURLOPT_ENCODING => '',
		  CURLOPT_MAXREDIRS => 10,
		  CURLOPT_TIMEOUT => 0,
